...
export function useSynchronizedRequest<RequestDataType, ResponseType>(
  ...
  const executeSynchronizedRequest = useCallback(
    async (data?: RequestDataType): Promise<ResponseType | undefined> => {
      ...
      return new Promise(async (resolve) => {
        ...
        try {
          ...
          handleRejectedPromiseRef.current
            ? handleRejectedPromiseRef.current(e)
            : console.error(e);
        }
